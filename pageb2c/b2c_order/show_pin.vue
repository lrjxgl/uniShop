	...
	export default{
		...
		methods:{
			getPage:function(){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/mm/b2c_order/show?orderid="+this.orderid,
			...
			cancel:function(){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/mm/b2c_order/cancel?orderid="+this.orderid,
					success:function(rs){
						that.getPage();
					}	
				})
			...
			receive:function(){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/mm/b2c_order/receive?orderid="+this.orderid,
					success:function(rs){
						that.getPage();
					}	
				})
